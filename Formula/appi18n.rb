...
class Appi18n < Formula
  ...
  url "https://github.com/jaywcjlove/app-i18n/releases/download/v1.7.0/appi18n.tar.gz"
  sha256 "e0d07df9db012028c8e991ac053a5b7a2608ff765a2d2315d38a86ecaa74e51f"
  license "MIT"
