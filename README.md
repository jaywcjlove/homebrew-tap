...
|---------|-------------|---------|
| [appi18n](https://github.com/jaywcjlove/app-i18n) | Lightweight CLI tool for unifying and optimizing the internationalization (i18n) workflow | v1.7.0 |
| [linkly](https://github.com/jaywcjlove/linkly) | A Swift command-line tool that generates beautiful, responsive link aggregation pages (like Linktree) from a single `linkly.json` config file. | v1.2.0 |
...
| [spa](https://github.com/jaywcjlove/spa) | SPA is a small Swift command for adding a Swift Package dependency to an Xcode GUI project. | v0.1.8 |
...
### [Mousio Hint](https://github.com/jaywcjlove/mousio-hint) `v1.8.1`
